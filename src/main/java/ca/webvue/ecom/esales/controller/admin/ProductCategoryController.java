...
import ca.webvue.ecom.esales.service.BrandService;
...
public class ProductCategoryController extends BaseController {
	...
	/**
	 * Display page for adding a new product category
	 * @param model
	 * @return
	 */
	...
	/**
	 * Create a product category. Set its parent category and associated brands 
	 * 
...
//		productCategory.setPromotions(null);
	...
	/**
	 * Display a product category edit page. Get its data and related object ready
	 * @param id
	 * @param model
	 * @return
	 */
	...
	/**
	 * List all the categories in tree view
	 */
