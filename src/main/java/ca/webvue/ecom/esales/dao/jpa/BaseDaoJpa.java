...
import ca.webvue.ecom.esales.dao.BaseDao;
import ca.webvue.ecom.esales.entity.OrderEntity;
import ca.webvue.ecom.esales.search.Filter;
import ca.webvue.ecom.esales.search.Filter.Operator;
...
public abstract class BaseDaoJpa<T, ID extends Serializable> implements BaseDao<T, ID> {
