...
/**
 * Freemarker method for shortening a character string
 * @author ezhu
 *
 */

@Component("abbreviateMethod")
public class AbbreviatedMethod implements TemplateMethodModel {
	...
	/**
	 * 
	 * @param str		Original character string
	 * @param width		Width of shortened string
	 * @param ellipsis	Character string appended to the shortened one. Ex. ...
	 * @return
	 */
